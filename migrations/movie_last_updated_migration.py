...
host = "mongodb+srv://m220student:m220password@cluster0.kqzom.mongodb.net/myFirstDatabase?retryWrites=true&w=majority"
...
for doc in cursor:
    ...
    movies_to_migrate.append(
        {"doc_id": ObjectId(doc_id), "lastupdated": parser.parse(lastupdated)}
    )
